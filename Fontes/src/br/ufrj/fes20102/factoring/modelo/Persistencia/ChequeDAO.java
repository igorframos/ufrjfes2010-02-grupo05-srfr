...
import br.ufrj.fes20102.factoring.modelo.Apresentacao.ChequeVO;
import br.ufrj.fes20102.factoring.modelo.Dominio.Cheque;

/**
 * 
 * Classe responsável pela interação entre a classe <b>Cheque</b> do Domínio e o
 * Banco de Dados
 * 
 */
public class ChequeDAO {
	...
	/**
	 * Construtor, inicia a Sessão com o Hibernate, carregando as configurações
	 * estabelecidas.
	 * 
	 * @throws Exception
	 */
	 ...
	 * 
	 * @return Um <b>List</b> de <b>ChequeVO</b> com todos os cheques do sistema
	 */
	 ...
	 * 
	 * @param devolvido
	 * @return Um <b>List</b> de <b>ChequeVO</b> que contém todos os cheques do
	 *         BD ou somente os cheques devolvidos.
	 */
	 ...
	 * 
	 * @param cpf
	 * @return <b>List</b> de cheques contendo todos os cheques associados à
	 *         entrada.
	 */
	...
	/**
	 * Lista todos os cheques correspondentes ao CPF ou só os devolvidos
	 * 
	 * @param cpf
	 * @param devolvido
	 * @return <b>List</b> contendo todos os cheques do CPF ou só os cheques do
	 *         CPF que foram devolvidos.
	 */
