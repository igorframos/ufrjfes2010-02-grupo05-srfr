...
public class TesteUtilitarios {
	...
	public void testaDataString() {
		...
		assertTrue("Problema em passar Data para String", Utilitarios
				.dateToString(hoje).equals("06/12/2010"));

		assertTrue("Problema em passar Data para String", Utilitarios
				.dateToString(ontem).equals("04/12/2010"));

		assertTrue("Problema em passar Data para String", Utilitarios
				.dateToString(mesPassado).equals("05/11/2010"));
	}
	...
	public void testaStringData() {
		...
		assertTrue("Problema em passar String para Date",
				datasIguais(dataTeste, temp));
